...
TRANS = {
    ...
    "In your Buddy List, friends who already own Small World 2 will have a \"SW\" icon next to their name. You can also send a Private Message to those friends of yours who don't own the game yet. They will be able to read their Private Messages directly on the Days of Wonder Web site.": "在你的好友列表中，已拥有小小世界的朋友名字旁边会有\"SW\"图标。你也可以向那些还没有游戏的朋友发送私人消息。他们将能够直接在 Days of Wonder 网站上阅读他们的私人消息。",
